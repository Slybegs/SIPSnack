...
<div class="form-group {{ $errors->has('harga_beli') ? 'has-error' : ''}}">
    ...
    <input class="form-control" rows="5" name="harga_beli" type="text" id="harga_beli" {{ isset($produk->harga_beli) ? $produk->harga_beli : ''}} > 
...
<div class="form-group {{ $errors->has('harga_jual') ? 'has-error' : ''}}">
    ...
    <input class="form-control" rows="5" name="harga_jual" type="text" id="harga_jual" {{ isset($produk->harga_jual) ? $produk->harga_jual : ''}} > 
...
<div class="form-group {{ $errors->has('gambar') ? 'has-error' : ''}}">
    ...
    @if(isset($produk->gambar))
        <img src="{{ asset($produk->gambar) }}" alt="Your image" class="img-thumbnail mt-1" width="200">
    @else
